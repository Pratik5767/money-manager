...
public class NotificationService {
	...
	public void sendDailyExpenseSummary() {
		...
		for (ProfileEntity profile : profiles) {
			List<ExpenseDto> expenses = expenseService.getExpensesForUserOnDate(profile.getId(),
			...
			if (!expenses.isEmpty()) {
				...
				table.append("<th style='border:1px solid #ddd;padding:8px;'>No</th>");
				...
				for (ExpenseDto expense : expenses) {
					table.append("<tr>");
					table.append("<td style='border:1px solid #ddd;padding:8px;text-align:center;'>").append(i++)
							.append("</td>");
				...
				String body = "Hi " + profile.getFullName()
						+ ",<br/><br/> Here is a summary of your expense for today:<br/><br/>" + table
						+ "<br/><br/> Best regards, <br/><br/>Money Manager Team";
